...
subtitle: "nicar.r-journalism.com/2025/"
...
* nicar.r-journalism.com/2025/ (Follow along here)
...
* The two required arguments are [`geography`](https://www.census.gov/newsroom/blogs/random-samplings/2014/07/understanding-geographic-relationships-counties-places-tracts-and-more.html) and [`variables`](https://censusreporter.org/topics/table-codes/).  The function defaults to the latest 5-year ACS (Currently 2019-2023) 
...
```{r view-acs}
median_income # type this in the console and press enter
```
...
## How to get this table from data.census.gov

![](img/censusportal.png)

## How the table looks from census.gov

![](img/censusdownload.png)
...
# Understanding variables and geograpy in tidycensus



## Searching for variables

* A good guide on available tables of variables is on [CensusReporter.org](https://censusreporter.org/topics/table-codes/)
...
## Search for "coupled households" in the search bar

![](img/coupled_households.png)
...
* Example: data on median home value in Los Angeles County, California by Census tract
...
## Somali speakers by state (5-year ACS)
